// Struktur kode di go
package main // sebuah aplikasi / main function(func main()) golang harus terdapat di dalam sebuah package yang bernama main
...
func main() { //tiap tiap file go, harus memiliki main function, yaitu function utama yang akan dieksekusi ketika program dijalankan
